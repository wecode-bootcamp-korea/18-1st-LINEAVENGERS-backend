    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('no', models.CharField(default='', max_length=5)),
            ],
            options={
                'db_table': 'categories',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('no', models.CharField(default='', max_length=5, unique=True)),
            ],
            options={
                'db_table': 'menus',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('follwers', models.ManyToManyField(related_name='followed_products', through='mypage.Favorite', to='account.User')),
